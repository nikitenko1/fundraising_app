...
const CampaignCard = ({ title, description, image, progress, slug }) => {
  return (
    <div className="rounded-md shadow-lg border border-gray-100 hover:scale-105 transition-[transform]">
      ...
      <div className="p-5">
        ...
        <Link
          to={`/campaign/${slug}`}
          className="float-right outline-0 bg-green-400 hover:bg-green-500 transition-[background] text-white text-sm  rounded-md px-4 py-2 block w-fit mt-5"
        >
          Detail
        </Link>
