  ...
  return (
    ...
    >
      <div
        ...
        } transition-all bg-white w-full max-w-[500px] rounded-md text-center p-10`}
      >
        <img
        ...
        <div className="flex items-center gap-6 justify-center mt-7">
          <button
            ...
            className="bg-red-500 hover:bg-red-600 transition-[background] rounded-md text-white w-32 h-10"
          >
            Yes, I&apos;m sure
          </button>
          <button
            onClick={() => setOpenModal(false)}
            className="bg-gray-200 hover:bg-gray-300 transition-[background] h-10 w-24 rounded-md"
          >
            Cancel
          </button>
        </div>
